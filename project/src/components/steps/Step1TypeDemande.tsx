            ...
            <Alert role="region" aria-labelledby="student-info">
              ...
              <AlertDescription>
                ...
                <ul className="text-sm space-y-1">
                  <li>• Réservé aux personnes de moins de 25 ans</li>
                  <li>• Nationalité suisse ou permis B/C/F valable</li>
                  <li>• Première formation à Lausanne ou Lausanne Région</li>
                  <li>• Bourse ou activité accessoire ≥ 6'000 CHF/an</li>
                </ul>
              </AlertDescription>
            </Alert>
          )}
