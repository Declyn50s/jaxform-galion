        ...
        <CardContent className="space-y-6">
          ...
          <Alert role="region" aria-labelledby="lausanne-notice">
            ...
            <AlertDescription>
              ...
              <p className="text-sm">
                Les communes alentours (Renens, Prilly, Le Mont-sur-Lausanne, etc.) ne sont pas Lausanne.
                Seule la commune de Lausanne est acceptée pour ces critères.
              </p>
            </AlertDescription>
          </Alert>
          ...
          <div className="space-y-4">
            <Label className="text-base font-medium">
              Habitez-vous à Lausanne depuis 3 ans sans interruption ?
            </Label>
          ...
          <AnimatePresence>
            {showWorkQuestion && (
              ...
              >
                <Label className="text-base font-medium">
                  Travaillez-vous à Lausanne depuis 3 ans sans interruption ?
                </Label>
